    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900 transition-all duration-500">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              {isAuthenticated ? (
                <Link
                  to="/admin"
                  className="flex items-center space-x-2 px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-lg transition-all duration-200 hover:scale-105"
                >
          ...
          <div className="text-center space-y-8 animate-fade-in">
            <div className="relative">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-48 h-48 bg-gradient-to-r from-blue-400 to-teal-400 rounded-full blur-3xl opacity-20 animate-pulse"></div>
              </div>
              
              {/* Larger Profile Image from GitHub */}
              <div className="relative w-48 h-48 mx-auto mb-8 rounded-full bg-gradient-to-br from-blue-500 to-teal-500 p-2 animate-bounce-slow shadow-2xl">
                <div className="w-full h-full rounded-full bg-white dark:bg-gray-900 flex items-center justify-center overflow-hidden">
                  ...
                  <div className="w-full h-full rounded-full bg-white dark:bg-gray-900 items-center justify-center hidden">
                    <span className="text-6xl font-bold bg-gradient-to-br from-blue-500 to-teal-500 bg-clip-text text-transparent">
                      UT
                    </span>
                  </div>
                </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                I'm a Computer Science Engineering student at VIT Bhopal with a focus on Artificial Intelligence and Machine Learning. My passion lies in developing innovative AI solutions and exploring the frontiers of machine learning applications. Through my journey, I strive to create intelligent systems that can make a meaningful impact on society..
              </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-4 pt-8">
              <a
                ...
                className="flex items-center space-x-2 px-6 py-3 bg-gray-900 hover:bg-gray-800 text-white rounded-full transition-all duration-200 hover:scale-105 hover:shadow-lg"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-full transition-all duration-200 hover:scale-105 hover:shadow-lg"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 px-6 py-3 bg-teal-600 hover:bg-teal-700 text-white rounded-full transition-all duration-200 hover:scale-105 hover:shadow-lg"
              >
              ...
              <a
                ...
                className="flex items-center space-x-2 px-6 py-3 bg-orange-600 hover:bg-orange-700 text-white rounded-full transition-all duration-200 hover:scale-105 hover:shadow-lg"
              >
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white/30 dark:bg-gray-800/30">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex flex-wrap justify-center gap-2 mb-2">
                {githubStats.languages.slice(0, 2).map((lang) => (
                  <span key={lang} className="px-2 py-1 text-xs bg-purple-100 dark:bg-purple-900 text-purple-700 dark:text-purple-300 rounded">
                    {lang}
                  </span>
                ))}
              </div>
              <div className="text-gray-600 dark:text-gray-300">Top Languages</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {skills.map((skill, index) => (
              <div
                key={skill.name}
                className="group relative p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 animate-slide-up"
        ...
        <div className="max-w-7xl mx-auto">
            ...
            {featuredProjects.map((project, index) => (
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  />
                  {/* Status Tag - Only visible on hover with solid colors and larger font */}
                  <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <span className={`inline-flex items-center space-x-2 px-4 py-2 text-sm font-bold rounded-full backdrop-blur-sm ${getStatusColor(project.status)} text-white shadow-lg`}>
          ...
          <div className="text-center mt-12">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center space-x-2 px-6 py-3 bg-gray-900 hover:bg-gray-800 text-white rounded-lg transition-all duration-200 hover:scale-105"
            >
              <Github className="w-5 h-5" />
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="relative">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-64 h-64 bg-gradient-to-r from-blue-400 to-teal-400 rounded-full blur-3xl opacity-10 animate-pulse"></div>
            </div>
            <div className="relative space-y-8">
              <div className="flex justify-center">
                <div className="p-4 bg-gradient-to-r from-blue-500 to-teal-500 rounded-2xl">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <div className="flex items-center space-x-2 px-4 py-2 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded-full">
                  <Download className="w-4 h-4" />
                  <span>Free Downloads</span>
                </div>
                <div className="flex items-center space-x-2 px-4 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded-full">
                  <Users className="w-4 h-4" />
                  <span>Open Access</span>
                </div>
                <div className="flex items-center space-x-2 px-4 py-2 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 rounded-full">
              ...
              <Link
                to="/notes"
                className="inline-flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-teal-600 hover:from-blue-700 hover:to-teal-700 text-white rounded-2xl text-lg font-semibold transition-all duration-300 hover:scale-105 hover:shadow-2xl"
              >
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="flex justify-center space-x-6 mb-8">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 bg-gray-100 dark:bg-gray-800 hover:bg-gray-900 hover:text-white dark:hover:bg-gray-700 rounded-full transition-all duration-200 hover:scale-110"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 bg-gray-100 dark:bg-gray-800 hover:bg-blue-100 dark:hover:bg-blue-900 rounded-full transition-all duration-200 hover:scale-110"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 bg-gray-100 dark:bg-gray-800 hover:bg-teal-100 dark:hover:bg-teal-900 rounded-full transition-all duration-200 hover:scale-110"
            >
              <Globe className="w-5 h-5 text-gray-600 dark:text-gray-400" />
            </a>
            <a
              href="mailto:tiwarimerit@gmail.com"
              className="p-3 bg-gray-100 dark:bg-gray-800 hover:bg-orange-100 dark:hover:bg-orange-900 rounded-full transition-all duration-200 hover:scale-110"
            >
